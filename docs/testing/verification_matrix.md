...
|---|---|---|---|
| REQ-M0-001 | `pwd` | Path berada di `/home/.../src/mcsos` | PASS |
| REQ-M0-002 | `bash tools/check_env.sh` | Semua tool wajib `[OK]` atau warning terdokumentasi | PASS |
...
| REQ-M0-005 | `make smoke` | Object ELF64 x86-64 relocatable berhasil dibuat | PASS |
...
| REQ-M0-011 | `git log --oneline -n 3` | Minimal satu commit M0 tersedia | PASS |
